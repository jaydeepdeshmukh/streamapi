...
public class GenderAssociates {
	...
	public static void main(String[] args) {
		...
		Map<String, Long> maleFemaleCount = associateList.stream().collect(Collectors.groupingBy(Associate::getGender, Collectors.counting()));
