...
/** Problem: Get Youngest Male Employee in Product Department
 * *************************************************************
 * Solution:
 * Filter out all males and product department
 * find youngest using min **/
public class YoungestMaleInDept {
	...
	public static void main(String[] args) {
		...
		//Optional<Associate> youngestMaleInProductWrapper = associateList.stream().filter(a -> a.getGender()=="Male" &amp,&amp, e.getDepartment()=="Product Development").min(Comparator.comparingInt(Associate::getAge));
//		Associate youngestMale = youngestMaleInProductWrapper.get();
//
//		System.out.println("Details Of Youngest Male Employee In Product Development");
//
//		System.out.println("----------------------------------------------");
//
//		System.out.println("ID : "+youngestMale.getId());
//
//		System.out.println("Name : "+youngestMale.getName());
//
//		System.out.println("Age : "+youngestMale.getAge());
//
//		System.out.println("Year Of Joining : "+youngestMale.getYearOfJoining());
//
//		System.out.println("Salary : "+youngestMale.getSalary());
	}
