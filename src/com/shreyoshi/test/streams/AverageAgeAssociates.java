...
/** Problem: What is the average age of male and female associates
 * ****************************************************************
 * Solution:
 * Group by gender first
 * average age of males and females **/
public class AverageAgeAssociates {
...
List<Associate> associateList = new ArrayList<Associate>();
		...
		Map<String, Double> map = associateList.stream().collect(Collectors.groupingBy(Associate::getGender, Collectors.averagingInt(Associate::getAge)));
		System.out.println("Average age of male and female is:: "+map);
	}
