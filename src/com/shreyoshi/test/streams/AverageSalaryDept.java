...
/** Problem: Find Average salary in each department
 * *************************************************
 * Solution:
 * Use group by department
 * find average of each department salary**/
public class AverageSalaryDept {
	...
	public static void main(String[] args) {
		...
		Map<String,Double> map = associateList.stream().collect(Collectors.groupingBy(Associate::getDepartment, Collectors.averagingDouble(Associate::getSalary)));
