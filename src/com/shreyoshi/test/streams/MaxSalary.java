...
/** Problem: Get the details of Highest paid associate in the organization 
 * ************************************************************************
 * Solution:
 * Optional object is used
 * Comparator is used for sorting out the salary of associate
 * maxBy() method returns highest paid associate **/
...
List<Associate> associateList = new ArrayList<Associate>();
		...
		Optional<Associate> highestPaidAssociateWrapper = associateList.stream().collect(Collectors.maxBy(Comparator.comparingDouble(Associate::getSalary)));
		
		Associate highestPaid = highestPaidAssociateWrapper.get();
		System.out.println("===================================");
