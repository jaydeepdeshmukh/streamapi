...
/** Problem: Print the name of all departments in the organization
 * ***************************************************************
 * Solution:
 * We use foreach to print all departments and
 * distinct to get all department names only once i.e., no duplicate names **/
public class DepartmentNames {
	...
	public static void main(String[] args) {
		...
		associateList.stream().map(Associate::getDepartment).distinct().forEach(System.out::println);
	}
